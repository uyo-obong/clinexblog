...
return [
    ...
    */
    ...
    'cloudName'  => env('CLOUDINARY_CLOUD_NAME', 'uyo-obong'),
    ...
    'apiKey'     => env('CLOUDINARY_API_KEY', '998443124482244'),
    'apiSecret'  => env('CLOUDINARY_API_SECRET', 'a5G-1yvZajxU29kPUrMHLOk_g-Y'),
